const en = {
  ...
  loginPage: {
    ...
    emailHint: "Add an email to receive notifications and a welcome email.",
    role: "Role",
    citizen: "Citizen",
    rescuer: "Rescuer",
    admin: "Admin",
  ...
  settings: {
    ...
    family: {
      ...
      healthNotePlaceholder: "Health notes (optional)...",
      updateStatus: "Update Status",
      updating: "Updating...",
      statusUpdated: "Status updated!",
      lastLocation: "Last known location",
      close: "Close",
      noMembersHint: "No family members yet. Press \"Add Member\" to get started.",
      searchPlaceholder: "Enter phone number (e.g. 0901234567 or +84901234567)",
      relationPlaceholder: "Relation (e.g. Dad, Mom...)",
      relationDefault: "Family member",
    },
    appearance: {
      theme: "Theme",
      light: "Light",
  ...
  nav: {
    ...
    "rescuer-missions": "Team Missions",
    "rescuer-team": "Rescuer Team",
    "rescuer-monitoring": "Monitoring Center",
    news: "News & Alerts",
    ...
    "admin-monitoring": "Monitoring Center",
    "admin-analytics": "System Analytics",
    settings: "Settings",
    logout: "Logout",
  },

  // ── Monitoring Center (IoT sensors + drones) ──
  monitoring: {
    title: "Monitoring Center",
    subtitleAdmin: "Track water-level IoT devices and computer-vision drone surveillance across the region.",
    ...
    drones: {
      ...
      allFeeds: "All Drone Feeds",
      detections: "Detections",
      confidence: "Confidence",
      person: "Person",
      personDanger: "Person in danger",
  ...
  rescueQueue: {
    ...
    tracking: "Tracking",
    complete: "Complete",
    confirmCompleteTitle: "Complete this mission?",
    confirmCompleteMessage: "Confirm marking this mission as completed. This action cannot be undone.",
    back: "Go back",
    cancel: "Cancel",
    ...
    rescuerTitle: "Team Missions",
    rescuerSubtitle: "View and manage rescue missions assigned to your team",
    rescuerStatToStart: "To Start",
    rescuerStatMissions: "In Progress",
    rescuerStatCompleted: "Completed",
    rescuerTabToStart: "To Start",
    rescuerTabMissions: "Team Missions",
    rescuerTabCompleted: "Completed",
    rescuerEmptyToStartTitle: "No missions waiting to start",
    rescuerEmptyToStartHint: "When admin assigns an SOS to your team, it will appear here for you to start",
    rescuerEmptyMissionsTitle: "No active missions in progress",
    rescuerEmptyMissionsHint: "Started missions will appear here",
    ...
    noTeamFullTitle: "Join or Create a Rescue Team",
    noTeamFullHint: "Team Missions shows all missions assigned to your rescue group. Create or join a team to get started.",
  },
  ...
  teamPage: {
    ...
    searchDirectory: "Search rescuers",
    filterAll: "All",
    filterAvailable: "Available",
    filterInvited: "Invited",
    filterInTeam: "In a team",
    addDescription: "Add a description",
    statActiveShort: "active",
    statDoneShort: "completed",
    statMembersShort: "members",
    invitationsCount: "You have {n} invitation(s)",
    orWaitForInvite: "Or wait for an invite — check the Invites tab",
    timeJustNow: "Just now",
